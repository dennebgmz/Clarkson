...
class AdminController extends Controller
{
  ...
  return view('admin.members_ledger', array('member' => $member, 'recentcontributions' => $recentcontributions, 'recentloans' => $recentloans, 'contributions' => $contributions, 'totalcontributions' => $totalcontributions, 'outstandingloans' => $outstandingloans, 'totalloanbalance' => $totalloanbalance));
  }
  ...
  public function memberData(Request $request)
  {
    ...
    if ($posts) {
      foreach ($posts as $r) {
        ...
        $row[] = "<a data-md-tooltip='View Member Ledger' class='md-tooltip--right' id='view_records' data-id='" . $r->id . "' style='cursor: pointer'>
                    <i class='mp-icon md-tooltip--right icon-folder-alt mp-text-c-primary mp-text-fs-large'></i>
                  </a>";
