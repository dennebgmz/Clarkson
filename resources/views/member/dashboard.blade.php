 ...
 @if(prme_pr())
      ...
      <div class="col-lg-12">
        <div class="row no-gutters">
          <div class="col-12 mp-ph2 mp-pv2">
            <div class="mp-ph4 mp-pv4 mp-card mp-card--plain">
                 <div class="mp-text-fs-large mp-text-fw-heavy">ATTN: SG 1-15 members from UP Manila, and PGH for the year {{  election() ? election()->year : '' }} is On-going. &nbsp;&nbsp; <a  href="{{url('/member/election/')}}{{  election() ? '/'.election()->id : '' }}" class="mp-link mp-link--primary mp-text-fs-medium">
                  CLICK HERE TO VOTE
                  </a></div>
            </div>
          </div>
