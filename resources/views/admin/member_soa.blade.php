                        ...
                        <div class="mp-ph4 mp-pv4 mp-card mp-card--plain">
                            <div class="mp-text-no-lh">
                                <div class="mp-text-right">
                                    ...
                                    @endif
                                    <br>
                                    <a href="{{ url('/admin/change_status/' . $member->user_id) }}"
                                        class="mp-link mp-link--primary">Change Membership Status</a>
                            ...
                            <div class="mp-mt3">
                                ...
                                <a href="{{ url('/admin/member_profile/' . $member->user_id) }}"
                            ...
                            <div>
                                ...
                                <label id="contactNo" href="#" class="mp-link mp-link--primary ">
                    ...
                    <div class="col-12 mp-ph2 mp-pv2">
                        <div class="mp-ph4 mp-pv4 mp-card mp-card--plain">
                            ...
                            <div class="mp-mt1 mp-text-right">
                                <a href="{{ url('/admin/member_equity/' . $member->user_id) }}"
                                    class="mp-link mp-link--primary }}">
                                    See All
                                </a>
                            </div>
                            ...
                            <div class="mp-mt1 mp-text-right">
                                <a href="{{ url('/admin/member_loans/' . $member->user_id) }}"
                                    class="mp-link mp-link--primary">See All</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4 mp-ph2 mp-pv2">
                <div class="mp-ph4 mp-pv4 mp-card">
                    ...
                    <div class="mp-card__footer mp-text-right">
                        <a href="{{ url('/admin/generate/soa/' . $member->user_id) }}" target="_blank"
                            class="mp-link mp-link--primary">
                            Download PDF
                        </a>
                    </div>
